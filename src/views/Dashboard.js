      ...
      <Container fluid>       
        ...
        <Col md="6">
          ...
          <Col md="6">
            <Card>
              <Card.Header>
                <Card.Title as="h4">User's Scopes</Card.Title>
              </Card.Header>
              <Card.Body>
                <div
                  className="ct-chart ct-perfect-fourth"
                ...
                <div className="legend">
                  <i className="fas fa-circle text-info"></i>
                  pro <i className="fas fa-circle text-danger"></i>
                  enterprise <i className="fas fa-circle text-warning"></i>
                  lite<i className="fas fa-circle text-primary"></i>freemium
                </div>
                <hr></hr>
              </Card.Body>
            </Card>
